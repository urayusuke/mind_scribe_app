...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, bool isFirstLaunch});
}
...
class _$SplashStateImpl implements _SplashState {
  const _$SplashStateImpl({this.isLoading = true, this.isFirstLaunch = true});
  ...
  @override
  String toString() {
    return 'SplashState(isLoading: $isLoading, isFirstLaunch: $isFirstLaunch)';
  }
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({final bool isLoading, final bool isFirstLaunch}) =
      _$SplashStateImpl;
